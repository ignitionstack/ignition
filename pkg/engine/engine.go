...
// DEPRECATED: Legacy method signatures maintained for backward compatibility

// LoadFunctionWithContextAndForce is a backward-compatibility method.
// Use LoadFunctionWithForce instead.
//
// Parameters:
//   - ctx: Context for cancellation and timeout
//   - namespace: The function namespace
...
// LoadFunction is a backward-compatibility method that creates a context with the default timeout.
// Use LoadFunctionWithContext instead for explicit context control.
//
// Parameters:
//   - namespace: The function namespace
//   - name: The function name
...
// CallFunction is a backward-compatibility method that creates a context with the default timeout.
// Use CallFunctionWithContext instead for explicit context control.
//
// Parameters:
//   - namespace: The function namespace
//   - name: The function name
